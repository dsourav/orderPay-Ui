...
class _QrCOdeResultRestaurentState extends State<QrCOdeResultRestaurent> {
  ...
  _buildHomeCardWidget() {
    return Container(
        child: ListView(
      children: <Widget>[
        buildCardItem('assets/images/chicken_noodles.png',
            'Rahat Brasserie-Berkarar Mall', '299 Levent/Besiktas', "\$21.14"),
        buildCardItem('assets/images/recipelab.png', 'Seasonal soup-Restaurant',
            '299 Levent/Besiktas', "\$11.05"),
        buildCardItem('assets/images/tofu.png', 'Cautro Formaggie-Soup',
            '299 Levent/Besiktas', "\$17.94"),
      ],
    ));
  }
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(
                  child: Container(
                    margin:
                        EdgeInsets.only(top: 10.0, bottom: 10.0, right: 8.0),
                    child: Column(
                      children: <Widget>[
                        Expanded(
                          child: Text(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Icon(
                                Icons.star,
                                size: 10.0,
                                color: ConstantColors.amberColor,
                              ),
                              Text('4.9',
                                  style: TextStyle(
                                    fontSize: 13.0,
